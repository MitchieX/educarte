...
if(isset($_POST['email'])) {
    ...
    $email_to = "falecom@colegioeducarte.com3";
...
echo "<script>alert("Obrigado! Em breve entraremos em contato");window.location.assign('http://www.colegioeducarte.com/');</script>";
